 ...
 */
public class CalendarAdapterProject extends BaseAdapter implements View.OnTouchListener {
    ...
    String projectid,projectTitle,projectStatus;

    public CalendarAdapterProject(Activity activity, List<CalendarPojo> projectsList, List<CardAssociatedCalendarLabelsPojo> labelList, List<CardAssociatedCalendarMembersPojo> memberList, List<CardAssociatedCalendarCoverPojo> coverList, int membercount, AlertDialog alertDialog,List<CardAssociatedCalendarCheckBox> cardCheckboxPojoList,String projectid,String projectTitle,String projectStatus) {
