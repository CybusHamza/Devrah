...
public class CalendarAdapter extends BaseAdapter implements View.OnTouchListener {
    ...
    public CalendarAdapter(Activity activity, List<CalendarPojo> projectsList) {
